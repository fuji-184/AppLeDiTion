<footer class="relative py-20 flex flex-col items-center bg-gradient-to-b from-black to-green-900 overflow-hidden md:py-40">
            ...
            <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                <div class="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
                    <ul class="list-disc list-inside space-y-8">
                        ...
                        <li><a href="#" class="hover:text-green-400 transition">Guide</a></li>
                        <li><a href="#" class="hover:text-green-400 transition">Blocks</a></li>
                        <li><a href="#" class="hover:text-green-400 transition">Contact</a></li>
                        <li><a href="#" class="hover:text-green-400 transition">Terms of Use</a></li>
                    </ul>
