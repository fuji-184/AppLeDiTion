...
<div class="bg-gradient-to-b from-black via-emerald-950 to-black p-8 pt-24 md:px-[16%]">
<div class="bg-gradient-to-b from-teal-500 via-emerald-950 to-black text-emerald-100 border border-emerald-500 p-8 rounded-3xl shadow-lg shadow-emerald-500">
